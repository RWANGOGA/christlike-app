  ...
  return (
    <div className="relative min-h-screen bg-[#F5EFE6] overflow-hidden flex flex-col">
      ...
      <nav className="relative z-10 flex items-center justify-between px-8 py-6 max-w-7xl mx-auto w-full">
        <span className="font-[family-name:var(--font-display)] text-2xl text-[#5A4A4A] tracking-wide">
          Christ-Like
        </span>
        <div className="flex items-center gap-4">
          <button
            onClick={() => { setAuthMode('login'); setShowAuth(true); }}
            className="text-sm text-[#5A4A4A]/70 hover:text-[#5A4A4A] transition font-medium"
          >
            Sign In
          </button>
          <button
            onClick={() => { setAuthMode('register'); setShowAuth(true); }}
            className="text-sm px-6 py-2.5 rounded-full bg-[#D4A5A5] text-white font-medium hover:bg-[#C99595] transition shadow-lg shadow-[#D4A5A5]/30"
          >
            Get Started
          </button>
        </div>
      ...
      <main className="relative z-10 flex-1">
        <section className="relative">
          ...
          <div className="relative max-w-4xl mx-auto px-6 pt-20 pb-28 text-center">
            ...
            <h1 className="font-[family-name:var(--font-display)] text-5xl lg:text-6xl leading-tight text-[#5A4A4A] mb-6">
              Let His Word dwell in you<br />
              <span className="text-[#D4A5A5] italic">richly.</span>
            </h1>

            <p className="text-[#5A4A4A]/70 text-lg lg:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
            ...
            <div className="grid grid-cols-3 gap-8 pt-8 border-t border-[#5A4A4A]/10 max-w-lg mx-auto">
              <div>
                <p className="text-3xl font-bold text-[#5A4A4A]">66</p>
                <p className="text-sm text-[#5A4A4A]/60">Books of Scripture</p>
              </div>
              <div>
                <p className="text-3xl font-bold text-[#5A4A4A]">Audio</p>
                <p className="text-sm text-[#5A4A4A]/60">& Text</p>
              </div>
              <div>
                <p className="text-3xl font-bold text-[#5A4A4A]">100%</p>
                <p className="text-sm text-[#5A4A4A]/60">Free, Always</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-[#7A6A6A]">
          <div className="max-w-6xl mx-auto px-6">
            <h2 className="font-[family-name:var(--font-display)] text-4xl lg:text-5xl text-white text-center mb-16">
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="mt-8 mb-32">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-center lg:text-left">
                ...
                <h2 className="font-[family-name:var(--font-display)] text-4xl lg:text-5xl leading-tight text-[#5A4A4A] mb-6">
          ...
          <div className="mt-16 mb-32">
            <div className="text-center mb-16">
              <h2 className="font-[family-name:var(--font-display)] text-4xl text-[#5A4A4A] mb-4">
          ...
          <div className="mt-16 mb-32">
            <div className="text-center mb-12">
              <h2 className="font-[family-name:var(--font-display)] text-5xl text-[#5A4A4A] mb-4">
          ...
          <div className="mt-16 mb-32">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
              <div className="relative">
                ...
                <div className="absolute -bottom-8 -left-8 w-64 bg-white rounded-2xl overflow-hidden shadow-xl">
                  <img
                    src="https://dwellapp.io/assets/churches-signup/person1-d6bc8888fbfa16255e9312488785246f4b344bcc6dab8d3e0715bdf8f5fae34c.jpg"
              ...
              <div>
                <h3 className="font-[family-name:var(--font-display)] text-4xl text-[#5A4A4A] mb-6">
          ...
          <div className="mt-16 mb-32">
            ...
            <div className="space-y-12 max-w-4xl mx-auto">
              <div className="bg-white/80 backdrop-blur-sm p-8 md:p-12 border border-[#5A4A4A]/5 shadow-lg">
                <div className="mb-6">
